...
3. `sketch2webpage-controlnet synthetic.ipynb`: contains code to generate the synthetic dataset based on output from `synthetic.ipynb`. Final dataset can be found here: https://huggingface.co/datasets/swetha3456/sketch2webpage-dataset-synthetic
4. `evaluation with sketch2webpage.ipynb`: contains code for qualitative and quantitative evaluation for the trained ControlNet models including the Sketch2Webpage models.
5. `sketch2webpage_demo.ipynb`: contains code for the demo gradio application for inference on the Sketch2Webpage trained model.
